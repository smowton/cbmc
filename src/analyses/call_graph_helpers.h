...
/// \param graph: call graph
/// \param function: function to query
/// \return vector of caller functions
...
/// \param graph: call graph
/// \param function: function to query
/// \return vector of reachable functions, including `function`
...
/// \param graph: call graph
/// \param function: function to query
/// \return vector of functions that can reach the target, including `function`
