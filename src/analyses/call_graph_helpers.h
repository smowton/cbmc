...
/// Get inverse-toplogical sorted (leaves first) call graph
/// \param graph: call graph
/// \return function names, sorted so that callees come before callers which
///   not in the same strongly-connected component.
